    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:anwarhussen3683@gmail.com" className="p-text">anwarhussen3683@gmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="phone" />
          <a href="tel:+251953814499" className="p-text">+2519-53-81-44-99</a>
        </div>
      </div>
      {!isFormSubmitted ? (
        <div className="app__footer-form app__flex">
          ...
          <div className="app__flex">
            <input className="p-text" type="text" placeholder="Subject (Optional)" name="subject" value={subject} onChange={handleChangeInput} />
          </div>
          <div>
            <textarea
              className="p-text"
